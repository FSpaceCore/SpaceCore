...
package com.fvbox.data.mapping
...
val permissionMapOnT = mapOf(
    ...
    "android.permission.READ_MEDIA_AUDIO" to "android.permission-group.READ_MEDIA_VISUAL",
    "android.permission.POST_NOTIFICATIONS" to "android.permission-group.NOTIFICATIONS",
    "android.permission.NEARBY_WIFI_DEVICES" to Manifest.permission_group.NEARBY_DEVICES,
    "android.permission.BODY_SENSORS_BACKGROUND" to Manifest.permission_group.SENSORS,
).toMutableMap().apply {
